...
/**
 * WhatsAppReferral Class Doc Comment
 *
 * @category Class
 ...
 */
class WhatsAppReferral implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppReferral';
    ...
    public const SOURCE_TYPE_AD = 'AD';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sourceType']) && !in_array($this->container['sourceType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'sourceType', must be one of '%s'",
                $this->container['sourceType'],
     ...
     * Sets sourceType
     *
     * @param string|null $sourceType Indicates the source of the referral. Takes the value of `UNKNOWN` if there's no value or the value is different from `AD` or `POST`.
     *
     * @return self
     */
     ...
     * Sets sourceId
     *
     * @param string|null $sourceId Facebook ID of an ad or a post.
     *
     * @return self
     */
     ...
     * Sets sourceUrl
     *
     * @param string|null $sourceUrl The URL that leads to a Facebook ad or a post.
     *
     * @return self
     */
