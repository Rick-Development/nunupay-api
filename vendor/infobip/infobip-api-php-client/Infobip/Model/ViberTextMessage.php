...
class ViberTextMessage implements ModelInterface
{
    public const DISCRIMINATOR = '';
    public const OPENAPI_MODEL_NAME = 'ViberTextMessage';
    ...
    protected \Infobip\Model\ViberTextContent $content,
    ...
    public function getContent(): \Infobip\Model\ViberTextContent
    {
        return $this->content;
    }

    public function setContent(\Infobip\Model\ViberTextContent $content): self
    {
