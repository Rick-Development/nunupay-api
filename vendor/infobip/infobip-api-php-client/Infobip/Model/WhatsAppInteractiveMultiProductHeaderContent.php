...
class WhatsAppInteractiveMultiProductHeaderContent implements ModelInterface
{
    public const DISCRIMINATOR = 'type';
    public const OPENAPI_MODEL_NAME = 'WhatsAppInteractiveMultiProductHeaderContent';
