<?php
/**
 * WhatsAppApiRequestErrorDetails
 *
 * PHP version 7.2
 *
 * @category Class
...
/**
 * WhatsAppApiRequestErrorDetails Class Doc Comment
 *
 * @category Class
 * @package  Infobip
 * @author   Infobip Support
 ...
 */
class WhatsAppApiRequestErrorDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhatsAppApiRequestErrorDetails';
     ...
     * Sets messageId
     *
     * @param string|null $messageId Identifier of the error.
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Detailed error description.
     *
     * @return self
     */
