...
final class ResendTwoFAPinCodeOverSMSTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/resend_two_fa_pin_code_over_sms_success.json');
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->resendTwoFAPinCodeOverSMS($resource);
    ...
    private function getResource(): ResendTwoFAPinCodeOverSMSResource
    {
        return new ResendTwoFAPinCodeOverSMSResource('pinId');
    }
}
