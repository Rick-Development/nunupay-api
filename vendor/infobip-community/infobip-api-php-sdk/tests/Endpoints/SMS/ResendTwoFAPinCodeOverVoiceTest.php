...
final class ResendTwoFAPinCodeOverVoiceTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/resend_two_fa_pin_code_over_voice_success.json');
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->resendTwoFAPinCodeOverVoice($resource);
    ...
    private function getResource(): ResendTwoFAPinCodeOverVoiceResource
    {
        return new ResendTwoFAPinCodeOverVoiceResource('pinId');
    }
}
