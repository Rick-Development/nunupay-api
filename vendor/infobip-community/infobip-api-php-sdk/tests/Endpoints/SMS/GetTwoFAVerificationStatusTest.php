...
final class GetTwoFAVerificationStatusTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/get_two_fa_verification_status_success.json');
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->getTwoFAVerificationStatus($resource);
    ...
    private function getResource(): GetTwoFAVerificationStatusResource
    {
        return new GetTwoFAVerificationStatusResource('appId', 'msisdn');
    }
}
