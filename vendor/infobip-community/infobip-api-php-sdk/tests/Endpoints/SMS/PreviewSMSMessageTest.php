...
final class PreviewSMSMessageTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/preview_sms_message_success.json');
    ...
    private function getResource(): PreviewSMSMessageResource
    {
        return new PreviewSMSMessageResource('text');
    }
}
