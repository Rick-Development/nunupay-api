...
final class GetScheduledSMSMessagesTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->getScheduledSMSMessages($resource);
    ...
    private function getResource(): GetScheduledSMSMessagesResource
    {
        return new GetScheduledSMSMessagesResource('bulkId');
    }
}
