...
final class GetTwoFAMessageTemplatesTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/get_two_fa_message_templates_success.json');
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->getTwoFAMessageTemplates($resource);
    ...
    private function getResource(): GetTwoFAMessageTemplatesResource
    {
        return new GetTwoFAMessageTemplatesResource('appId');
    }
}
