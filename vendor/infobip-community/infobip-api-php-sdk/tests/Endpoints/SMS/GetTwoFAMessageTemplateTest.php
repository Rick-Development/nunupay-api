...
final class GetTwoFAMessageTemplateTest extends TestCase
{
    public function testApiCallExpectsSuccess(): void
    {
        // arrange
        $resource = $this->getResource();
        $mockedResponse = $this->loadJsonDataFixture('Endpoints/SMS/get_two_fa_message_template_success.json');
        ...
        $response = $this
            ->getInfobipClient()
            ->SMS()
            ->getTwoFAMessageTemplate($resource);
    ...
    private function getResource(): GetTwoFAMessageTemplateResource
    {
        return new GetTwoFAMessageTemplateResource('appId', 'msgId');
    }
}
