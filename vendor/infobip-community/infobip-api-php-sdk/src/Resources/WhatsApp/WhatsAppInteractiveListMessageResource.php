 ...
 */
final class WhatsAppInteractiveListMessageResource implements ResourcePayloadInterface, ResourceValidationInterface
{
    /** @var string */
    private $from;
    ...
    public function __construct(
        string $from,
        string $to,
        InteractiveListContent $content
    ) {
        $this->from = $from;
        $this->to = $to;
