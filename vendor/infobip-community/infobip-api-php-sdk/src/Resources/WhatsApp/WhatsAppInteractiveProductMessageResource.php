 ...
 */
final class WhatsAppInteractiveProductMessageResource implements ResourcePayloadInterface, ResourceValidationInterface
{
    /** @var string */
    private $from;
    ...
    public function __construct(
        string $from,
        string $to,
        InteractiveProductContent $content
    ) {
        $this->from = $from;
        $this->to = $to;
