            ...
            <div class="col-lg-6 seo-setting">
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Form -->
                            <form action="{{ route('admin.firebase.config.update') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                            ...
                                            <button type="button" id="vapid_key" class="input-group-append input-group-text">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                            ...
                                            <button type="button" id="api_key" class="input-group-append input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                            ...
                                            <button type="button" id="auth_domain" class="input-group-append input-group-text">
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <span class="d-block text-dark">@lang("Push Notification")</span>
                                                                <p class="fs-5 text-body mb-0">@lang("Push notification are messages that pop up while a user is in your app.")</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-check form-switch">
                                                                    <input type="hidden" value="0" name="push_notification" />
                                                                    <input class="form-check-input @error('push_notification') is-invalid @enderror" type="checkbox" name="push_notification" id="push_notification" value="1"
                                                                        {{ $basicControl->push_notification == 1 ? 'checked' : '' }} >
                                                                    <label class="form-check-label" for="push_notification"></label>
                                            ...
                                            <div class="list-group-item">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <span class="d-block text-dark">@lang("User Foreground")</span>
                                                                <p class="fs-5 text-body mb-0">@lang("Push notification send when user online.")</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-check form-switch">
                                                                    <input type="hidden" value="0" name="user_foreground" />
                                                                    <input class="form-check-input @error('user_foreground') is-invalid @enderror" type="checkbox" name="user_foreground" id="user_foreground" value="1"
                                                                        {{ $firebaseNotify['user_foreground'] == 1 ? 'checked' : '' }} >
                                                                    <label class="form-check-label" for="user_foreground"></label>
                                            ...
                                            <div class="list-group-item">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <span class="d-block text-dark">@lang("User Background")</span>
                                                                <p class="fs-5 text-body mb-0">@lang("Push notification send when user offline.")</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-check form-switch">
                                                                    <input type="hidden" value="0" name="user_background" />
                                                                    <input class="form-check-input @error('user_background') is-invalid @enderror" type="checkbox" name="user_background" id="user_background" value="1"
                                                                        {{ $firebaseNotify['user_background'] == 1 ? 'checked' : '' }} >
                                                                    <label class="form-check-label" for="user_background"></label>
                                            ...
                                            <div class="list-group-item">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <span class="d-block text-dark">@lang("Admin Foreground")</span>
                                                                <p class="fs-5 text-body mb-0">@lang("Push notification send when admin offline.")</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-check form-switch">
                                                                    <input type="hidden" value="0" name="admin_foreground" />
                                                                    <input class="form-check-input @error('admin_foreground') is-invalid @enderror" type="checkbox" name="admin_foreground" id="admin_foreground" value="1"
                                                                        {{ $firebaseNotify['admin_foreground'] == 1 ? 'checked' : '' }} >
                                                                    <label class="form-check-label" for="admin_foreground"></label>
                                            ...
                                            <div class="list-group-item">
                                                <div class="d-flex">
                                                    <div class="flex-grow-1">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <span class="d-block text-dark">@lang("Admin Background")</span>
                                                                <p class="fs-5 text-body mb-0">@lang("Push notification send when admin online.")</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <div class="form-check form-switch">
                                                                    <input type="hidden" value="0" name="admin_background" />
                                                                    <input class="form-check-input @error('admin_background') is-invalid @enderror" type="checkbox" name="admin_background" id="admin_background" value="1"
                                                                        {{ $firebaseNotify['admin_background'] == 1 ? 'checked' : '' }} >
                                                                    <label class="form-check-label" for="admin_background"></label>
