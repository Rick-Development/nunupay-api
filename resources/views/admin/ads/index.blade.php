                    ...
                    <div class="row">
                        @forelse($ads as $ad)
                            <div class="col-md-4 mb-3">
                                <div class="card">
                                    <img src="{{ asset('storage/app/public/' . $ad->image) }}" alt="Ad Image" class="card-img-top">
                                    <!--me.airpero.com/public/storage/ads-->
                                    <div class="card-footer text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('admin.ads.edit', $ad->id) }}" class="btn btn-warning btn-sm">{{ __('Edit') }}</a>
                                        <!-- Delete Form -->
                                        <form action="{{ route('admin.ads.destroy', $ad->id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to delete this ad?') }}');" class="d-inline-block">
                                            @csrf
                                            @method('DELETE')
