...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::middleware(['auth:superadmin','verifyAdmin'])->group(function () {
...
Route::match(['get', 'post'], 'ads', [AdController::class, 'index'])->name('ads.index');
...
Route::post('ads', [AdController::class, 'store'])->name('ads.store');
        ...
        Route::get('gift-card/edit/{id}', [VirtualCardController::class, 'edit'])->name('gift.cardEdit');
        Route::put('gift-card/update/{id}', [VirtualCardController::class, 'update'])->name('gift.cardUpdate');
        Route::post('gift-card/status-change/{id}', [VirtualCardController::class, 'statusChange'])->name('gift.cardStatusCng');

        Route::get('gift-card/order', [VirtualCardController::class, 'cardOrder'])->name('gift.cardOrder');
        Route::get('gift-card/order/detail/{id}', [VirtualCardController::class, 'cardOrderDetail'])->name('gift.cardOrderDetail');
        Route::post('gift-card/order/rejected/{id}', [VirtualCardController::class, 'cardOrderRejected'])->name('gift.cardOrderRejected');
        Route::get('gift-card/order/approve/{id}', [VirtualCardController::class, 'cardOrderApprove'])->name('gift.cardOrderApprove');

        Route::get('gift-card/list/{type?}', [VirtualCardController::class, 'cardList'])->name('gift.cardList');
        Route::get('gift-card/list/view/{id}', [VirtualCardController::class, 'cardView'])->name('gift.cardView');
        Route::get('gift-card/transaction/{id}', [VirtualCardController::class, 'cardTransaction'])->name('gift.cardTransaction');
        Route::post('gift-card/block/{id}', [VirtualCardController::class, 'cardBlock'])->name('gift.cardBlock');
        Route::post('gift-card/un-block/{id}', [VirtualCardController::class, 'cardUnBlock'])->name('gift.cardUnBlock');
        Route::post('gift-card/fund-approve/{id}', [VirtualCardController::class, 'cardFundApprove'])->name('gift.cardFundApprove');
        Route::post('gift-card/fund-return/{id}', [VirtualCardController::class, 'cardFundReturn'])->name('gift.cardFundReturn');
